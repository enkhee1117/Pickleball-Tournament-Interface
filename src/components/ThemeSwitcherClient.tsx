...
// The theme picker on the profile/settings page. With JS each choice applies
// optimistically (instant data-theme swap + cookie write, active state tracked
// locally); the form action is the no-JS fallback.
export function ThemeSwitcherClient({ initial }: { initial: Theme }) {
